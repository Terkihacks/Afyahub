...
export default function Sidebar(){
    return(
        <>
     <aside className="sidebar fixed w-64  min-h-screen flex flex-col overflow-y-auto shadow-md  rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 rounded-lg xm:hidden ">
        {/* Logo Section */}
        <div className="flex items-centre flex-shrink-0">
            {/* <img className='h-10 w-25 mr-2 rounded-lg ' src={logo} alt="" /> */}
            <h1 className='text-4xl text-centre font-bold py-5 px-5 bg-gradient-to-r from-orange-500 to-red-800 text-transparent bg-clip-text'>Afyahub</h1>
        </div>
